...
class GoalEntryDto {
  ...
  @ApiProperty({
    example: 0.08,
    description:
      'Porcentaje de crecimiento sobre el total real del mes anterior, como fracción (0.08 = 8%). Puede ser negativo (meta de decrecimiento).',
  })
  @IsNumber()
  @Min(-1)
  @Max(5)
...
export class UpsertGoalsBulkDto {
